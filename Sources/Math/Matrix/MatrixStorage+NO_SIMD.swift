...
//
//
//  Created by Math on 06.09.19.
//

#if !FRB_MATH_USE_SIMD
// MARK: - Storage3x3
public struct Storage2x2<Value>: Storage2x2Protocol where Value: SScalar {
...
// MARK: - Storage3x3
public struct Storage3x3<Value>: Storage3x3Protocol where Value: SScalar {
...
// MARK: - Storage4x4Ref
public struct Storage4x4<Value>: Storage4x4Protocol where Value: SScalar {
